      ...
      parts.push(
        <span
          ...
          className={`bg-gradient-to-r ${
            isDark ? 'from-blue-400 to-cyan-300' : 'from-[#0092BB] to-blue-600'
    ...
    >
      <div className="fixed top-4 right-4 z-50">
        <button
          ...
          className={`p-2 sm:p-3 rounded-full shadow-lg border backdrop-blur-md transition-all duration-300 hover:scale-110 ${
            isDark
      ...
      >
        ...
        <div className="relative mx-auto px-4 sm:px-6 xl:px-12 z-10 flex flex-col justify-center items-center py-16 sm:py-20">
          <div className="text-center mb-8">
            <h1
              className={`text-2xl sm:text-4xl md:text-6xl font-bold mb-4 leading-tight ${
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-10 w-full max-w-5xl">
            {heroData.stats.map((stat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`group relative rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center backdrop-blur-md border transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer ${
                    isDark
