...
const Header = () => {
  ...
  // Effect for mobile dropdown click outside
  React.useEffect(() => {
  ...
  // Effect for desktop dropdown click outside
  React.useEffect(() => {
  ...
  return (
    <header
      className="header left-0 top-0 z-40 flex w-full items-center absolute bg-transparent py-8"
      role="banner"
