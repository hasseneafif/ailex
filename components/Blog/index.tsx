...
const ProjectList = () => {
  ...
  {projectData.map((project, idx) => (
    ...
    >
      <span className="holographic-card-before pointer-events-none select-none"></span>
      <div className="flex flex-col items-start mb-4 w-full z-10">
        ...
        />
        <span className="font-xoireqe text-left text-[0.85rem] md:text-[1rem] text-white font-light w-full">
          {project.title}
        </span>
      </div>
